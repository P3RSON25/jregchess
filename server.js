...
function handleAction(peer, message) {
  ...
  switch (message.action) {
    ...
    case "buy": accepted = coordinates([message.x, message.y]) && ["Normal", "Heaven", "Hell"].includes(message.board || "Normal") ? game.buy(String(message.id || ""), message.x, message.y, message.board || "Normal") : game.reject("Invalid board coordinates or board."); break;
